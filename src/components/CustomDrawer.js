  ...
  return (
    <View style={{flex: 1,backgroundColor: '#2538B8'}}>
      ...
      <View style={{padding: 20, borderTopWidth: 1, borderTopColor: '#ccc'}}>
        <TouchableOpacity onPress={() => {}} style={{paddingVertical: 15,borderRadius:6,margin:4}}>
        ...
        <TouchableOpacity onPress={() => {Logout()}} style={{paddingVertical: 15,borderRadius:8,margin:4}}>
          <View style={{flexDirection: 'row', alignItems: 'center'}}>
